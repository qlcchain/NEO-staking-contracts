    ...
    public void wrapperUnlock12() {
        ...
        try {
            ...
            ContractInvocation contractInvocation = new ContractInvocation.Builder(neow3j).contractScriptHash(contractScripthash)
                    ...
                    .parameter(ContractParameter.string("f98b3db2b9d24b1c9710211128cce8c0"))
            ...
            RawScript witnessFrom = new RawScript(new ScriptBuilder().pushData("f98b3db2b9d24b1c9710211128cce8c0").pushInteger(1).opCode(OpCode.PACK).pushData("wrapperUnlock").toArray() , contractScripthash);
